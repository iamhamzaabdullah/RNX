...
cells = [
    code_cell(
        """
        # IMPORTANT: RUN THIS CELL TO IMPORT YOUR KAGGLE DATA SOURCES.
        ...
        qiweiyin_protenix_v1_adjusted_path = kagglehub.dataset_download('qiweiyin/protenix-v1-adjusted')
        amirrezaaleyasin_biotite_path = kagglehub.dataset_download('amirrezaaleyasin/biotite')
        iamhamzaabdullah_rnapro_src_path = kagglehub.dataset_download('iamhamzaabdullah/rnapro-src')
        iamhamzaabdullah_rnapro_private_best_500m_ckpt_path = kagglehub.dataset_download('iamhamzaabdullah/rnapro-private-best-500m-ckpt')
        shujun717_ribonanzanet2_pytorch_alpha_1_path = kagglehub.model_download('shujun717/ribonanzanet2/PyTorch/alpha/1')
    ...
    code_cell(
        ...
        IDEAL_STEP = np.array([2.75, 0.55, 3.10], dtype=np.float32)
    ...
    code_cell(
        ...
        def neural_bank_placeholder(seq, tbm_preds):
            # Safe fallback when heavy neural assets are missing.
            # This still helps diversity by building learned-style perturbation proxies.
...
out = Path(r"C:\Users\Bilal Abdullah\Documents\New project\RNX_benchmark_0699_redeveloped.ipynb")
