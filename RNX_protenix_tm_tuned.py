...
def tbm_phase(test_df, train_seqs_df, train_coords_dict, segments_map):
    ...
    for _, row in test_df.iterrows():
        ...
        elif USE_PROTENIX and EXTRA_PROTENIX_FOR_WEAK_TBM and len(preds) >= N_SAMPLE:
            if best_pct < WEAK_TBM_PCT_THRESHOLD and weak_extra_count < EXTRA_PROTENIX_MAX_TARGETS:
